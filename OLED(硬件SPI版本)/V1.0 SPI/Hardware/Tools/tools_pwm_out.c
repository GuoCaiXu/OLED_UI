...
void Tools_PWM_Switch(void);                        // PWM输出开关
void Tools_PWM_SetOutputPSCuency(void);             // 修改PSC
void Tools_PWM_SetOutputARRuency(void);             // 修改ARR
void Tools_PWM_SetOutputDutyuency(void);            // 修改占空比
void Tools_PWM_SetOutputPolarity(void);             // 输出电平
void Tools_PWMOut_VariableUpdates(void);                       // 参数更新函数

Option_Class Option_ToolsPWMOUTMenu[] = {
    {"<<<", NULL},
    {"PWM输出[关]", Tools_PWM_Switch},
    {"频率: %d hz", NULL, 1000},
    {"PSC: %d", Tools_PWM_SetOutputPSCuency, 72},
    {"ARR: %d", Tools_PWM_SetOutputARRuency, 1000},
    {".."},
    {"\0"},
    {"..", NULL},
    {"\0"}
...
void Tools_OptionPWMOut_MENU(void){
    ...
    MENU_RunMain(Option_ToolsPWMOUTMenu, Tools_PWMOut_VariableUpdates);
}
...
void Tools_PWM_Switch(void){
    ...
    if (pwm_switch == 0){
        ...
        Option_ToolsPWMOUTMenu[5].str = "..";
        Option_ToolsPWMOUTMenu[5].Variables = NULL;
        Option_ToolsPWMOUTMenu[5].func = NULL;
        Option_ToolsPWMOUTMenu[6].str = "\0";
        Option_ToolsPWMOUTMenu[6].func = NULL;
...
void Tools_PWMOut_VariableUpdates(void){
