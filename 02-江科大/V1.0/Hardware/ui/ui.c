 ...
 * @LastEditTime: 2024-01-18 22:32:51
 * @FilePath: \Project_EIDEc:\SyncFile\03-Project\05-OLED_UI\02-江科大\V1.0\Hardware\ui\ui.c
 * @Description: 
 * 
...
void ui_show(void){
    ...
    ui_run(&y, &y_trg, 2, 5);
	ui_run(&frame_y, &frame_y_trg, 2, 5);							// 框框的y值的ui
	ui_run(&frame_len, &frame_len_trg, 2, 5);
	OLED_Update();
}
